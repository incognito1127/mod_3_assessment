...
const { getAllAnimes, getOneAnime, createOneAnime, updateOneAnime, deleteOneAnime } = require("../queries/animes");
...
// ]
//INDEX 
// This route handles GET requests to the root path ("/") of the animes resource. It is used to retrieve a list of all animes.
...
// }
//DELETE
// This route handles DELETE requests to remove a specific anime by its ID.
